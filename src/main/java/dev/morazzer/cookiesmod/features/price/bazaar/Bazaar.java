...
public class Bazaar implements Module {
    ...
    private void updateProducts() {
        ...
        JsonObject jsonObject = JsonUtils.gsonClean.fromJson(body, JsonObject.class);
        ...
        for (String key : products.keySet()) {
            ...
            ProductSummary[] buySummary = JsonUtils.gsonClean.fromJson(
                    product.getAsJsonArray("buy_summary"),
                    ProductSummary[].class
            );
            ProductSummary[] sellSummary = JsonUtils.gsonClean.fromJson(
                    product.getAsJsonArray("sell_summary"),
                    ProductSummary[].class
            );
            QuickStatus quickStatus = JsonUtils.gsonClean.fromJson(
