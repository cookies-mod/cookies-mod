 ...
 * @param value           The item it needs, null when requirementType is
 *                        {@linkplain dev.morazzer.cookiesmod.features.repository.items.item.attributes.GemstoneSlotRequirementType#COINS}.
