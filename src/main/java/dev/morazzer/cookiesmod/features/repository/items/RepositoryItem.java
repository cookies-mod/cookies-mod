...
public class RepositoryItem {
    ...
    public RepositoryItem(JsonObject jsonObject) {
                ...
                if (gemstoneSlot.has("costs")) {
                    for (JsonElement costsElement : gemstoneSlot.getAsJsonArray("costs")) {
                        ...
                        if (type.equalsIgnoreCase("COINS")) {
                            ...
                            slotRequirements.add(new GemstoneSlotRequirement<>(GemstoneSlotRequirementType.ITEM, ItemUtils.skyblockIdToIdentifier(costs.get("item_id").getAsString()).orElseThrow(), costs.get("amount").getAsInt()));
                        }
        ...
        if (jsonObject.has("salvage")) {
            ...
            this.salvage = Optional.of(new SalvageUpgrade<>(SalvageType.ITEM, ItemUtils.skyblockIdToIdentifier(salvage.get("item_id").getAsString()).orElseThrow(), salvage.get("amount").getAsInt()));
        } else {
        ...
        if (jsonObject.has("prestige")) {
            ...
            Identifier itemId = ItemUtils.skyblockIdToIdentifier(prestigeObject.get("item_id").getAsString()).orElseThrow();
