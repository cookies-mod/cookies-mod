...
/**
 * Static variables related to model overrides.
 */
public interface ItemModelOverrides {
    ...
    Identifier[] ITEM_MODEL_PRECISE_MATCHES =
        new Identifier[] {ITEM_MODEL_PREDICATE_SKYBLOCK_ID, ITEM_MODEL_PREDICATE_REFORGE,
            ITEM_MODEL_PREDICATE_DISPLAY_NAME};
    Identifier[] ITEM_MODEL_SHOULD_RESPECT_OTHER_PREDICATES =
        new Identifier[] {ITEM_MODEL_PREDICATE_SKYBLOCK_ID, ITEM_MODEL_PREDICATE_REFORGE,
            ITEM_MODEL_PREDICATE_DISPLAY_NAME};
