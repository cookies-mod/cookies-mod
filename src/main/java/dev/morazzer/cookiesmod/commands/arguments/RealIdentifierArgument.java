 ...
 * {@linkplain java.util.Collection} instance. Meaning you can always adjust the values of that
 * {@linkplain java.util.Collection} instance while the argument exists. Note that you might want to use a thread-save
 * version of the {@linkplain java.util.Collection} type to avoid
...
public class RealIdentifierArgument implements ArgumentType<Identifier> {
    ...
    private static final DynamicCommandExceptionType IDENTIFIER_NOT_FOUND =
        new DynamicCommandExceptionType(id -> CookiesMod
    ...
    /**
     * Constructor to create a {@linkplain dev.morazzer.cookiesmod.commands.arguments.RealIdentifierArgument} with no
     ...
     *                                {@linkplain net.minecraft.util.Identifier#isNamespaceValid(String)} and the
     *                                {@linkplain net.minecraft.util.Identifier#isPathValid(String)} methods
     */
     ...
     *                                {@linkplain java.util.Collection}.
     */
    @Override
     ...
     *
     * @param context The {@link com.mojang.brigadier.context.CommandContext} provided by the
     *                {@link com.mojang.brigadier.builder.ArgumentBuilder#executes(com.mojang.brigadier.Command)}
     *                method.
     * @param builder A {@link com.mojang.brigadier.suggestion.SuggestionsBuilder} which is also provided by the
